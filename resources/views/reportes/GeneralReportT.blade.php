          ...
          <div class="table-responsive">
            <table id='example1' class="table no-margin">
              ...
              <tbody>
                 ...
                 <tr>
                  <td><a href="{{ route('reportGtable') }}">CON056</a></td>
                ...
                <tr>
                  <td><a href="{{ route('reportGtable') }}">AGR025</a></td>
                ...
                <tr>
                  <td><a href="{{ route('reportGtable') }}">ISC154</a></td>
                ...
                <tr>
                  <td><a href="{{ route('reportGtable') }}">AMD015</a></td>
